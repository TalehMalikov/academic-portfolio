...
<video src="assets/media/avatar.mp4" autoplay loop muted playsinline style="display:block;width:100%;-webkit-mask-image:linear-gradient(to right, #000 calc(100% - 10px), transparent 100%), linear-gradient(to bottom, #000 calc(100% - 10px), transparent 100%);mask-image:linear-gradient(to right, #000 calc(100% - 10px), transparent 100%), linear-gradient(to bottom, #000 calc(100% - 10px), transparent 100%);-webkit-mask-composite:source-in;mask-composite:intersect"></video>
